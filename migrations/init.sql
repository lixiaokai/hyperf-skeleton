...
-- 正在导出表  base_admin._test 的数据：~13 rows (大约)
...
-- 正在导出表  multi_tenant.app 的数据：~2 rows (大约)
...
-- 导出  表 multi_tenant.app_tenant 结构
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='应用和租户关系表';

-- 正在导出表  multi_tenant.app_tenant 的数据：~0 rows (大约)
INSERT INTO `app_tenant` (`id`, `app_id`, `tenant_id`, `created_at`) VALUES
	(1, 'admin', 1, '2023-03-26 19:22:44');

-- 导出  表 multi_tenant.app_user 结构
...
-- 正在导出表  multi_tenant.app_user 的数据：~4 rows (大约)
...
-- 正在导出表  multi_tenant.menu 的数据：~7 rows (大约)
...
-- 导出  表 multi_tenant.permission 结构
...
-- 正在导出表  multi_tenant.permission 的数据：~45 rows (大约)
...
-- 正在导出表  multi_tenant.role 的数据：~5 rows (大约)
...
-- 导出  表 multi_tenant.role_permission 结构
...
-- 正在导出表  multi_tenant.role_permission 的数据：~4 rows (大约)
...
-- 导出  表 multi_tenant.role_user 结构
...
-- 正在导出表  multi_tenant.role_user 的数据：~5 rows (大约)
...
-- 正在导出表  multi_tenant.tenant 的数据：~2 rows (大约)
...
-- 导出  表 multi_tenant.tenant_role 结构
...
-- 正在导出表  multi_tenant.tenant_role 的数据：~5 rows (大约)
...
-- 导出  表 multi_tenant.tenant_user 结构
...
-- 正在导出表  multi_tenant.tenant_user 的数据：~0 rows (大约)
...
-- 正在导出表  multi_tenant.user 的数据：~0 rows (大约)
INSERT INTO `user` (`id`, `username`, `nickname`, `phone`, `status`, `created_at`, `updated_at`) VALUES
	(1, 'admin', '超管', '13800138000', 'enable', '2023-03-15 17:32:18', '2023-03-29 01:41:23'),
	(13, 'user1', '用户1', '13800138001', 'enable', '2023-03-28 21:50:24', '2023-03-29 01:41:28'),
	(15, 'user2', '用户2', '13800138002', 'enable', '2023-03-28 23:24:10', '2023-03-29 01:41:31'),
	(19, 'user3', '用户3', '13800138003', 'enable', '2023-03-29 02:00:07', '2023-03-29 02:00:07');

-- 导出  表 multi_tenant.user_admin 结构
...
-- 正在导出表  multi_tenant.user_admin 的数据：~0 rows (大约)
INSERT INTO `user_admin` (`id`, `username`, `nickname`, `phone`, `status`, `created_at`, `updated_at`) VALUES
	(1, 'admin', '超管', '13800138000', 'enable', '2023-03-22 19:10:14', '2023-03-29 02:00:34'),
	(13, 'user1', '用户1', '13800138001', 'enable', '2023-03-28 21:50:24', '2023-03-29 02:00:30'),
	(15, 'user2', '用户2', '13800138002', 'enable', '2023-03-28 23:24:10', '2023-03-29 02:00:27'),
	(19, 'user3', '用户3', '13800138003', 'enable', '2023-03-29 02:00:07', '2023-03-29 02:00:07');

-- 导出  表 multi_tenant.user_auth 结构
...
-- 正在导出表  multi_tenant.user_auth 的数据：~0 rows (大约)
